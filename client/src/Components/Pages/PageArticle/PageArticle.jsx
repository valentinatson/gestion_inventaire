            ...
            {articles.map((article, index) => (
              <div key={index} className={style.card}>
                ...
                <div className={style.buttonContainer}>
                  <button className={style.button} onClick={() => handleEditArticle(article.id_article)}>Modifier</button>
                  <button className={style.button} onClick={() => handleDeleteArticle(article.id_article)}>Supprimer</button>
                </div>
              </div>
            ))}
          </div>
